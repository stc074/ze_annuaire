 ...
 * @author pj
 */
public class CreerSousCategorie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            sousCategorie.getGetIdCat(request);
            if(request.getParameter("kermit")!=null) {
                sousCategorie.getPosts(request);
                sousCategorie.verifPosts();
                sousCategorie.enregSousCat();
            }
            SousCategories sousCategories=new SousCategories(sousCategorie.getIdCategorie());
            sousCategories.initListeAdmin();
            request.setAttribute("sousCategorie", sousCategorie);
            request.setAttribute("categories", categories);
            request.setAttribute("sousCategories", sousCategories);
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/nimdo/scripts/creersouscategorie.jsp");
